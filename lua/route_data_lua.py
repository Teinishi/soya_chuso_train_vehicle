...
def load(path: str):
    ...
    lcd_types = route_data.get('lcdTypes', [])
...
def create_stop_type_table(stations):
...
def create_coordinate_table(tracks):
...
def create_not_for_service_table(tracks):
...
def create_index_table(stations):
...
def create_door_side_table(tracks):
...
def create_arc_type_table(types):
...
def create_arc_track_table(tracks):
...
def create_doorcut_table(tracks):
...
def create_stop_position_table(tracks):
...
def create_jsms_pass_list(stations):
...
def create_jsms_route(stations):
...
def create_track_groups(stations):
...
def create_lcd_train_type_table(lcd_types):
...
def create_lcd_train_type_color_table(lcd_types):
